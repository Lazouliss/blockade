...
public class Board : MonoBehaviour
{
    ...
    void removeWall()
    {
        ...
        // V�rifiez d'abord si l'objet existe avant de le supprimer
        if (stackWall.Count > 0)
            Destroy(stackWall.Pop());
        else
        {
            Debug.LogWarning("La pile est vide, plus de mur � retirer");
        }
